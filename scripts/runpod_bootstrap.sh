...
main() {
  ...
  export ANIMATION_AUDIO_MOTION_TARGET_FPS="${ANIMATION_AUDIO_MOTION_TARGET_FPS:-22}"
  export ANIMATION_API_TOKEN="$(resolve_api_token "${PYTHON_BIN}")"
  export ANIMATION_VIDEO_ENCODER="${ANIMATION_VIDEO_ENCODER:-auto}"
  print_info "motion-config audio_motion_target_fps=${ANIMATION_AUDIO_MOTION_TARGET_FPS}"
